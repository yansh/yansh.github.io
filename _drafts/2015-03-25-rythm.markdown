...
I decided to explore the topic a bit deeper, starting with this post. As he was telling me about the venture, I started to see a lot of symmetry, in how he approached it then, to what is preached by the start-up community gurus today. Mark, obviously, never read those books; many of them weren't permitted nor existed in USSR, thus he didn't follow a particular script and yet I still can see all the preached patterns in his actions.
