...
This is particularly evident in academia [^8], where a majority of publications are on things that worked (i.e., we were right!). Failed experiments are rarely published or somehow advertised. The pressure to be always right makes, people in academia follow a safe path, trends and current "hot" topics. This is very strange because a lot of great discoveries were discovered accidentally.
