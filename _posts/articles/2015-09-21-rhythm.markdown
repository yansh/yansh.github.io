...
Mark was told that printing such a slip/report that cross-referenced information from different data sources is practically impossible. There was not software for it, so his developers need to create it. He proved them wrong.
